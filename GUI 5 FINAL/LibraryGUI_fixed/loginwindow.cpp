...
LoginWindow::LoginWindow(QWidget* parent) : QDialog(parent) {
    ...
    card->setStyleSheet("background-color:#EDE8DC; border-bottom-left-radius:10px;"
    ...
    roleLbl->setStyleSheet("color:#8A7560; font-weight:bold;");
    ...
    uLabel->setStyleSheet("color:#8A7560; font-weight:bold; font-size:12px;");
    usernameEdit = new QLineEdit;
    usernameEdit->setPlaceholderText("Enter username…");

    // Password
    auto* pLabel = new QLabel("Password");
    pLabel->setStyleSheet("color:#8A7560; font-weight:bold; font-size:12px;");
