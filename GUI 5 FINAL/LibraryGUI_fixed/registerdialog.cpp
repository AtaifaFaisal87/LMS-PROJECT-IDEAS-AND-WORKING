...
RegisterDialog::RegisterDialog(QWidget* parent) : QDialog(parent) {
    ...
    setMinimumWidth(520);
    setStyleSheet("background-color:#EDE8DC;");
    ...
    hdr->setStyleSheet("color:#7A1C2E; font-size:20px; font-weight:bold; font-family:Georgia,serif;");
    root->addWidget(hdr);

    auto* sep = new QFrame; sep->setFrameShape(QFrame::HLine);
    sep->setStyleSheet("color:#B8956A;");
    root->addWidget(sep);
