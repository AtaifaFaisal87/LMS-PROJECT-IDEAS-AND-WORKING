...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent) {
    ...
    hero->setStyleSheet(
        ...
        "stop:0 #D4C9B0, stop:0.5 #F5F0E8, stop:1 #D4C9B0);");
    ...
    subtitleLbl->setStyleSheet("color: #8A7560; font-size: 15px; background:transparent; font-style:italic;");
    ...
    regBtn->setStyleSheet(
        "background: transparent;"
        "color: #7A1C2E; border: 2px solid #7A1C2E;"
    ...
    footer->setStyleSheet("background-color:#EDE8DC; border-top:1px solid #B8956A;");
