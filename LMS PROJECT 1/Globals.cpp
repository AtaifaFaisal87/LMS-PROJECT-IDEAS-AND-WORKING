// ============================================================
// Globals.cpp
// Contains: implementations of all utility and validation
//           functions declared in Globals.h
// ============================================================
...
string getValidTime(string prompt)
{
    ...
    while (true)
    {
        ...
        else
        {
            ...
            if (hours < 1 || hours > 12) valid = false;
            if (minutes < 0 || minutes > 59) valid = false;
        }
...
// ---- LETTERS ONLY (for names, authors, categories) ----
