...
LoginWindow::LoginWindow(QWidget* parent) : QDialog(parent) {
    ...
    card->setStyleSheet("background-color:#232946; border-bottom-left-radius:10px;"
    ...
    roleLbl->setStyleSheet("color:#A5B4FC; font-weight:bold;");
    ...
    uLabel->setStyleSheet("color:#A5B4FC; font-weight:bold; font-size:12px;");
    usernameEdit = new QLineEdit;
    usernameEdit->setPlaceholderText("Enter username…");

    // Password
    auto* pLabel = new QLabel("Password");
    pLabel->setStyleSheet("color:#A5B4FC; font-weight:bold; font-size:12px;");
