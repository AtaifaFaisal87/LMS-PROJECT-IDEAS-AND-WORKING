...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent) {
    ...
    hero->setStyleSheet(
        ...
        "stop:0 #0D1137, stop:0.5 #1A1F3C, stop:1 #0D1137);");
    ...
    subtitleLbl->setStyleSheet("color: #A5B4FC; font-size: 15px; background:transparent;");
    ...
    regBtn->setStyleSheet(
        "background: transparent;"
        "color: #22D3EE; border: 2px solid #22D3EE;"
    ...
    footer->setStyleSheet("background-color:#0D1137; border-top:1px solid #3D5AF1;");
