...
public:
    ...
    bool operator==(const string &a) const { return author==a;}
    bool operator==(const string &c) const { return category==c;}
    bool operator==(const string &p) const { return publisher==p;}
...
public:
    ...
    void viewUserFines(int userID)
    {
        ...
        // 1. Show STORED fines (after return)
        ...
        // 2. Show LIVE fines (not returned yet)
        for (int i = 0; i < (int)transactions.size(); i++)
        {
